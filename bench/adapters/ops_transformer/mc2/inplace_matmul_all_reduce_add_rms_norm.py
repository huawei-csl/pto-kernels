...
def benchmark(repo_root, spec, artifacts_dir):
    ...
    try:
        ...
        report["reason"] = f"Distributed inplace_matmul_all_reduce_add_rms_norm baseline failed: {exc}"
    else:
    ...
    report_path = Path(artifacts_dir) / "ops_transformer_inplace_matmul_all_reduce_add_rms_norm_benchmark.json"
