...
PYBIND11_MODULE(pto_kernels_ops, m) {
  ...
  m.def("pto_causal_conv1d", &pto_isa_ops::run_causal_conv1d, py::arg("x"),
        py::arg("weights"), py::arg("bias"));
  m.def("pto_causal_conv1d_batched", &pto_isa_ops::run_causal_conv1d_batched,
