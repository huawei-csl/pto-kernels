...
extern "C" void call_triv_inv_col_sweep_fp16(uint32_t block_dim, void* stream,
                                             uint8_t* tensor_out,
                                             uint8_t* tensor_in,
                                             uint32_t in_length,
                                             uint32_t matrix_size) {
  triv_inv_col_sweep_fp16<<<block_dim, nullptr, stream>>>(
      tensor_in, tensor_out, in_length, matrix_size);
}
...
extern "C" void call_triv_inv_col_sweep_fp32(uint32_t block_dim, void* stream,
                                             ...
                                             uint32_t in_length,
                                             uint32_t matrix_size) {
  triv_inv_col_sweep_fp32<<<block_dim, nullptr, stream>>>(
      tensor_in, tensor_out, in_length, matrix_size);
}
