...
AICORE void main_kernel(__gm__ half *Q_handle, __gm__ half *K_handle, __gm__ half *V_handle, __gm__ half *S_handle, __gm__ float *G_handle, __gm__ float *Msk_handle, __gm__ half *workspace_1_handle, __gm__ half *workspace_2_handle, __gm__ half *workspace_3_handle, __gm__ half *O_handle, uint64_t ffts_Addr) {
  ...
  tl::ascend_pto::TileMatL1<half, 128, 128, 128, 128> q_l1;
  TASSIGN(q_l1, 0);
  ...
  TASSIGN(qs_l0, 65536);
  tl::ascend_pto::TileMatL1<half, 128, 128, 128, 128> qk_l1;
  TASSIGN(qk_l1, 98304);
  ...
  TASSIGN(msk_ub, 512);
  tl::ascend_pto::TileUbDataND<float, 64, 128, 64, 128> qk_ub;
  TASSIGN(qk_ub, 33280);
  ...
  tl::ascend_pto::TileUbDataND<half, 64, 128, 64, 128> qk_ub_half;
  TASSIGN(qk_ub_half, 99072);
  tl::ascend_pto::TileUbDataND<half, 64, 128, 64, 128> qs_ub_half;
  TASSIGN(qs_ub_half, 115456);
  tl::ascend_pto::TileUbDataND<float, 64, 128, 64, 128> qs_ub;
  TASSIGN(qs_ub, 131840);
  tl::ascend_pto::TileUbDataND<half, 64, 128, 64, 128> o_ub_half;
  TASSIGN(o_ub_half, 164608);
  tl::ascend_pto::TileUbDataND<float, 64, 128, 64, 128> o_ub;
  TASSIGN(o_ub, 512);
  auto vid = get_subblockid();
#if defined(__DAV_C220_CUBE__)
    tl::ascend_pto::copy_gm_to_l1<half, half, 1, 1, 1, 128, 128, 536870912, 33554432, 2097152, 128, 1, 128, 128>(Q_handle + (cid * 16384), 0, 0, 128, 128);
    tl::ascend_pto::copy_gm_to_l1<half, half, 1, 1, 1, 128, 128, 536870912, 33554432, 2097152, 128, 1, 128, 128>(K_handle + (cid * 16384), 32768, 0, 128, 128);
    tl::ascend_pto::gemm_v0<half, float, 128, 128, 128, 128, 128, 128, 128, false, true>(q_l1, k_l1, qk_l0, (bool)1);
    tl::ascend_pto::copy_gm_to_l1<half, half, 1, 1, 1, 128, 128, 536870912, 33554432, 2097152, 128, 1, 128, 128>(Q_handle + (cid * 16384), 0, 0, 128, 128);
    tl::ascend_pto::copy_gm_to_l1<half, half, 1, 1, 1, 128, 128, 33554432, 2097152, 16384, 128, 1, 128, 128>(S_handle + (cid * 16384), 65536, 0, 128, 128);
    tl::ascend_pto::gemm_v0<half, float, 128, 128, 128, 128, 128, 128, 128, false, false>(q_l1, s_l1, qs_l0, (bool)1);
    tl::ascend_pto::copy_l0c_to_gm<half, float, 1, 1, 1, 128, 128, 1, 536870912, 16384, 128, 1, 128, 128>(workspace_1_handle + (cid * 16384), 0, 0, 128, 128);
    tl::ascend_pto::copy_l0c_to_gm<half, float, 1, 1, 1, 128, 128, 1, 536870912, 16384, 128, 1, 128, 128>(workspace_2_handle + (cid * 16384), 65536, 0, 128, 128);
    tl::ascend_pto::set_cross_flag<PIPE_FIX>(0, 2);
    tl::ascend_pto::wait_cross_flag(1);
    tl::ascend_pto::copy_gm_to_l1<half, half, 1, 1, 1, 128, 128, 1, 536870912, 16384, 128, 1, 128, 128>(workspace_3_handle + (cid * 16384), 98304, 0, 128, 128);
    tl::ascend_pto::copy_gm_to_l1<half, half, 1, 1, 1, 128, 128, 536870912, 33554432, 2097152, 128, 1, 128, 128>(V_handle + (cid * 16384), 131072, 0, 128, 128);
    tl::ascend_pto::gemm_v0<half, float, 128, 128, 128, 128, 128, 128, 128, false, false>(qk_l1, v_l1, qkv_l0, (bool)1);
    tl::ascend_pto::copy_l0c_to_gm<half, float, 1, 1, 1, 128, 128, 1, 536870912, 16384, 128, 1, 128, 128>(workspace_2_handle + (cid * 16384), 0, 0, 128, 128);
    tl::ascend_pto::set_cross_flag<PIPE_FIX>(2, 2);
#endif
#if defined(__DAV_C220_VEC__)
    set_mask_norm();
    set_vector_mask(-1, -1);
    tl::ascend_pto::copy_gm_to_ub<float, float, 1, 1, 1, 1, 128, 1, 1, 1, 4194304, 1, 1, 128, pto::PadValue::Zero>(G_handle + (cid * 128), 0, 0, 1, 128);
    tl::ascend_pto::copy_gm_to_ub<float, float, 1, 1, 1, 64, 128, 1, 1, 16384, 128, 1, 64, 128, pto::PadValue::Zero>(Msk_handle + (vid * 8192), 512, 0, 64, 128);
  ...
  for (int32_t i = 0; i < 16; ++i) {
      ...
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> g_ub_temp_1;
      TASSIGN(g_ub_temp_1, 0 + 0 * 4);
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> coeff_ub_temp_0;
      ...
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> g_ub_temp_2;
      TASSIGN(g_ub_temp_2, 0 + 0 * 4);
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> coeff_ub_temp_1;
      ...
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> g_ub_temp_3;
      TASSIGN(g_ub_temp_3, 0 + 0 * 4);
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> coeff_ub_temp_2;
      ...
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> g_ub_temp_4;
      TASSIGN(g_ub_temp_4, 0 + 0 * 4);
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> coeff_ub_temp_3;
    ...
    tl::ascend_pto::copy_gm_to_ub<half, half, 1, 1, 1, 64, 128, 1, 536870912, 16384, 128, 1, 64, 128, pto::PadValue::Zero>(workspace_1_handle + ((cid * 16384) + (vid * 8192)), 99072, 0, 64, 128);
    tl::ascend_pto::set_flag_pipeline<PIPE_MTE2, PIPE_V> (0);
    tl::ascend_pto::wait_flag_pipeline<PIPE_MTE2, PIPE_V> (0);
    ...
    tl::ascend_pto::copy_gm_to_ub<half, half, 1, 1, 1, 64, 128, 1, 536870912, 16384, 128, 1, 64, 128, pto::PadValue::Zero>(workspace_2_handle + ((cid * 16384) + (vid * 8192)), 115456, 0, 64, 128);
    ...
    tl::ascend_pto::copy_ub_to_gm<half, half, 1, 1, 1, 64, 128, 1, 536870912, 16384, 128, 1, 64, 128>(workspace_3_handle + ((cid * 16384) + (vid * 8192)), 99072, 0, 64, 128);
  ...
  for (int32_t i_1 = 0; i_1 < 16; ++i_1) {
      ...
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> qs_ub_temp_0;
      TASSIGN(qs_ub_temp_0, 131840 + (i_1 * 512) * 4);
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> qs_ub_temp_1;
      ...
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> qs_ub_temp_2;
      TASSIGN(qs_ub_temp_2, 131840 + ((i_1 * 512) + 128) * 4);
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> qs_ub_temp_3;
      ...
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> qs_ub_temp_4;
      TASSIGN(qs_ub_temp_4, 131840 + ((i_1 * 512) + 256) * 4);
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> qs_ub_temp_5;
      ...
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> qs_ub_temp_6;
      TASSIGN(qs_ub_temp_6, 131840 + ((i_1 * 512) + 384) * 4);
      tl::ascend_pto::TileUbDataND<float, 1, 128, 1, 128> qs_ub_temp_7;
    ...
    tl::ascend_pto::copy_gm_to_ub<half, half, 1, 1, 1, 64, 128, 1, 536870912, 16384, 128, 1, 64, 128, pto::PadValue::Zero>(workspace_2_handle + ((cid * 16384) + (vid * 8192)), 164608, 0, 64, 128);
    tl::ascend_pto::set_flag_pipeline<PIPE_MTE2, PIPE_V> (0);
    tl::ascend_pto::wait_flag_pipeline<PIPE_MTE2, PIPE_V> (0);
    ...
    tl::ascend_pto::set_flag_pipeline<PIPE_V, PIPE_MTE3> (0);
    tl::ascend_pto::wait_flag_pipeline<PIPE_V, PIPE_MTE3> (0);
    tl::ascend_pto::copy_ub_to_gm<half, half, 1, 1, 1, 64, 128, 536870912, 33554432, 2097152, 128, 1, 64, 128>(O_handle + ((cid * 16384) + (vid * 8192)), 164608, 0, 64, 128);
#endif
}
