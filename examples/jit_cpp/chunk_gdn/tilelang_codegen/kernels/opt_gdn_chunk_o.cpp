...
AICORE void main_kernel(__gm__ half *Q_handle, __gm__ half *K_handle, __gm__ half *V_handle, __gm__ half *S_handle, __gm__ float *G_handle, __gm__ float *Msk_handle, __gm__ half *workspace_1_handle, __gm__ half *workspace_2_handle, __gm__ half *workspace_3_handle, __gm__ half *O_handle, uint64_t ffts_Addr) {
  ...
  auto vid = get_subblockid();
    ...
    tl::ascend_pto::copy_gm_to_l1<half, half, 1, 1, 1, 128, 128, 67108864, 33554432, 2097152, 128, 1, 128, 128>(Q_handle + (cid * 16384), 0, 0, 128, 128);
    tl::ascend_pto::copy_gm_to_l1<half, half, 1, 1, 1, 128, 128, 67108864, 33554432, 2097152, 128, 1, 128, 128>(K_handle + (cid * 16384), 32768, 0, 128, 128);
    ...
    tl::ascend_pto::copy_l0c_to_gm<half, float, 1, 1, 1, 128, 128, 1, 67108864, 16384, 128, 1, 128, 128>(workspace_1_handle + (cid * 16384), 0, 0, 128, 128);
    tl::ascend_pto::copy_l0c_to_gm<half, float, 1, 1, 1, 128, 128, 1, 67108864, 16384, 128, 1, 128, 128>(workspace_2_handle + (cid * 16384), 65536, 0, 128, 128);
    tl::ascend_pto::set_cross_flag<PIPE_FIX>(0, 2);
    tl::ascend_pto::wait_cross_flag(1);
    tl::ascend_pto::copy_gm_to_l1<half, half, 1, 1, 1, 128, 128, 1, 67108864, 16384, 128, 1, 128, 128>(workspace_3_handle + (cid * 16384), 98304, 0, 128, 128);
    tl::ascend_pto::copy_gm_to_l1<half, half, 1, 1, 1, 128, 128, 67108864, 33554432, 2097152, 128, 1, 128, 128>(V_handle + (cid * 16384), 131072, 0, 128, 128);
    tl::ascend_pto::gemm_v0<half, float, 128, 128, 128, 128, 128, 128, 128, false, false>(qk_l1, v_l1, qkv_l0, (bool)1);
    tl::ascend_pto::copy_l0c_to_gm<half, float, 1, 1, 1, 128, 128, 1, 67108864, 16384, 128, 1, 128, 128>(workspace_2_handle + (cid * 16384), 0, 0, 128, 128);
  ...
  for (int32_t i = 0; i < 16; ++i) {
    ...
    tl::ascend_pto::copy_gm_to_ub<half, half, 1, 1, 1, 64, 128, 1, 67108864, 16384, 128, 1, 64, 128, pto::PadValue::Zero>(workspace_1_handle + ((cid * 16384) + (vid * 8192)), 99072, 0, 64, 128);
    tl::ascend_pto::set_flag_pipeline<PIPE_MTE2, PIPE_V> (0);
    tl::ascend_pto::wait_flag_pipeline<PIPE_MTE2, PIPE_V> (0);
    ...
    tl::ascend_pto::copy_gm_to_ub<half, half, 1, 1, 1, 64, 128, 1, 67108864, 16384, 128, 1, 64, 128, pto::PadValue::Zero>(workspace_2_handle + ((cid * 16384) + (vid * 8192)), 115456, 0, 64, 128);
    ...
    tl::ascend_pto::copy_ub_to_gm<half, half, 1, 1, 1, 64, 128, 1, 67108864, 16384, 128, 1, 64, 128>(workspace_3_handle + ((cid * 16384) + (vid * 8192)), 99072, 0, 64, 128);
  ...
  for (int32_t i_1 = 0; i_1 < 16; ++i_1) {
    ...
    tl::ascend_pto::copy_gm_to_ub<half, half, 1, 1, 1, 64, 128, 1, 67108864, 16384, 128, 1, 64, 128, pto::PadValue::Zero>(workspace_2_handle + ((cid * 16384) + (vid * 8192)), 164608, 0, 64, 128);
    tl::ascend_pto::set_flag_pipeline<PIPE_MTE2, PIPE_V> (0);
    tl::ascend_pto::wait_flag_pipeline<PIPE_MTE2, PIPE_V> (0);
    ...
    tl::ascend_pto::set_flag_pipeline<PIPE_V, PIPE_MTE3> (0);
    tl::ascend_pto::wait_flag_pipeline<PIPE_V, PIPE_MTE3> (0);
    tl::ascend_pto::copy_ub_to_gm<half, half, 1, 1, 1, 64, 128, 67108864, 33554432, 2097152, 128, 1, 64, 128>(O_handle + ((cid * 16384) + (vid * 8192)), 164608, 0, 64, 128);
#endif
}
