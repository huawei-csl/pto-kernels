...
AICORE void main_kernel(__gm__ half *K_handle, __gm__ half *Beta_handle, __gm__ float *G_handle, __gm__ float *Msk_handle, __gm__ half *workspace_handle, __gm__ half *A_handle, uint64_t ffts_Addr) {
  ...
  auto vid = get_subblockid();
    ...
    tl::ascend_pto::copy_gm_to_l1<half, half, 1, 1, 1, 128, 128, 536870912, 33554432, 2097152, 128, 1, 128, 128>(K_handle + (cid * 16384), 0, 0, 128, 128);
    tl::ascend_pto::gemm_v0<half, float, 128, 128, 128, 128, 128, 128, 128, false, true>(k_l1, k_l1, a_l0, (bool)1);
    tl::ascend_pto::copy_l0c_to_gm<half, float, 1, 1, 1, 128, 128, 536870912, 33554432, 2097152, 128, 1, 128, 128>(workspace_handle + (cid * 16384), 0, 0, 128, 128);
    ...
    tl::ascend_pto::copy_gm_to_ub<half, half, 1, 1, 1, 1, 64, 1, 1, 1, 4194304, 1, 1, 64, pto::PadValue::Zero>(Beta_handle + ((cid * 128) + (vid * 64)), 512, 0, 1, 64);
    ...
    tl::ascend_pto::copy_gm_to_ub<half, half, 1, 1, 1, 64, 128, 536870912, 33554432, 2097152, 128, 1, 64, 128, pto::PadValue::Zero>(workspace_handle + ((cid * 16384) + (vid * 8192)), 67456, 0, 64, 128);
    tl::ascend_pto::set_flag_pipeline<PIPE_MTE2, PIPE_V> (0);
    tl::ascend_pto::wait_flag_pipeline<PIPE_MTE2, PIPE_V> (0);
    ...
    tl::ascend_pto::copy_ub_to_gm<half, half, 1, 1, 1, 64, 128, 536870912, 33554432, 2097152, 128, 1, 64, 128>(A_handle + ((cid * 16384) + (vid * 8192)), 67456, 0, 64, 128);
#endif
}
