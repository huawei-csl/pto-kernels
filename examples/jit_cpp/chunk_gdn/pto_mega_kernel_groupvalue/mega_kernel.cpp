...
namespace mk_kkt {
#include "../dynamic_bsnd_groupvalue/scaled_dot_kkt_kernel.cpp"
}
#undef call_kernel
...
namespace mk_wy {
#include "../dynamic_bsnd_groupvalue/wy_fast_kernel.cpp"
}
#undef call_kernel

#define call_kernel _mk_unused_gv_ck_h
namespace mk_h {
#include "../dynamic_bsnd_groupvalue/chunk_h_kernel.cpp"
}
#undef call_kernel

#define call_kernel _mk_unused_gv_ck_o
namespace mk_o {
#include "../dynamic_bsnd_groupvalue/chunk_o_kernel.cpp"
}
#undef call_kernel
