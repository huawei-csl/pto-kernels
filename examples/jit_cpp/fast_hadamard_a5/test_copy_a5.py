...
The copy reference is the yardstick every ``fast_hadamard_a5`` number is
...
def test_copy_is_bit_exact(copy_ref, batch):
...
def test_copy_touches_every_tile(copy_ref):
